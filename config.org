...
(setq zero/digital-garden "~/Dev/OrgFiles/DigitalGarden"
      ...
      zero/org-journal-dir "~/Dev/OrgFiles/Journal"
      zero/zero-logo "~/Dev/dots/zero/zero.png"
      zero/org-html-css "<link rel=\"stylesheet\" type=\"text/css\" href=\"/home/dhaval/Dev/dots/emacs/assets/simple.min.css\" />"
...
(global-set-key (kbd "C-z C-f C-c") 'open-configuration-file)
(general-define-key
 :prefix "C-z C-f"
 "c" '(open-configuration-file :which-key "Configuration File"))
#+end_src
...
(general-define-key
 ...
 "l" '(eval-last-sexp :which-key "Evaluate Last Expression")
...
(general-define-key
 :prefix "C-z C-o"
  "*" '(org-ctrl-c-star :which-key "")
  "+" '(org-ctrl-c-minus :which-key "")
  "." '(counsel-org-goto :which-key "")
  "e" '(org-export-dispatch :which-key "")
  "c" '(org-capture :which-key "")
  "f" '(org-footnote-new :which-key "")
  "h" '(org-toggle-heading :which-key "")
  "i" '(org-toggle-item :which-key "")
  "n" '(org-store-link :which-key "")
  "o" '(org-open-at-point :which-key "")
  "t" '(org-todo :which-key "")
  "x" '(org-toggle-checkbox :which-key "")
  "B" '(org-babel-tangle :which-key "")
  "I" '(org-toggle-inline-images :which-key "")
  "T" '(org-todo-list :which-key "")
  "s" '(org-schedule :which-key "")
  "a" '(org-agenda-list :which-key ""))
#+end_src
...
(setq org-directory zero/org-dir
      org-agenda-files '(zero-agenda-dir)
...
(setq org-export-html-style zero/org-html-css)
#+end_src
...
(general-define-key
 :prefix "C-z C-r"
  "b" '(org-roam-buffer-toggle :which-key "")
  "t" '(org-roam-tag-add :which-key "")
  "f" '(org-roam-node-find :which-key "")
  "g" '(org-roam-node-visit :which-key "")
  "u" '(org-roam-ui-mode :which-key "")
  "i" '(org-roam-node-insert :which-key "")
  "h" '(org-id-get-create :which-key "")
  "c" '(org-roam-capture :which-key "")
  "j" '(org-roam-dailies-capture-today :which-key ""))
...
;;(add-to-list 'ispell-hunspell-dict-paths-alist '("en_US" "/home/dhaval/Dev/dots/emacs/dicts/en_US.aff"))
...
(general-define-key
 :prefix "C-z C-w"
  "i"  '(writeroom-dive-in :which-key "")
  "o"  '(writeroom-dive-out :which-key "")
  "w"  '(writeroom-mode :which-key "")
  "s"  '(smart-quotes-mode :which-key "")
  "f"  '(auto-fill-mode :which-key "")
  "j"  '(justify-paragraph :which-key "")
  "m"  '(flyspell-correct-word-before-point :which-key "")
  "c"  '(count-words :which-key "")
  "u"  '(join-line :which-key ""))
#+end_src
#+end_src
...
(setq recentf-exclude '("/home/dhaval/Dev/dots/zero/*" "*.git/*"))
#+end_src
...
#+end_src
* MEOW
The configuration is in [[file:///~/.emacs.d/meow.el][Meow.el]]
#+begin_src emacs-lisp
(use-package meow)
(load 
 (expand-file-name
